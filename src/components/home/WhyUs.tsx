	...
	return (
		<section className='flex flex-col gap-14 items-center max-w-[1200px] mx-auto my-0'>
			<div className='flex flex-col gap-5'>
				...
				<p className='text-center max-w-screen-lg text-fontL'>
					This system encourages a more equitable and thoughtful distribution of
					votes, allowing minority voices to significantly influence the
					outcome. Promotes more representative and balanced decision-making in
			...
			<section className='relative'>
				...
				<div className='relative flex flex-col items-end'>
					...
					<article className='pb-8 px-28'>
						<p className='text-fontL text-end'>
							This system promotes a more equitable distribution of votes,
							giving minorities a voice to influence the outcome. It encourages
							a more representative and balanced decision-making process,
							ensuring it reflects the values and priorities of the group as a
							whole.
						</p>
					</article>
