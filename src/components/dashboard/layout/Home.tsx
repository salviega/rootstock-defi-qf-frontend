				...
				<div className='flex items-center gap-3'>
					...
					<div>
						...
						<p className='text-secdcolor text-fontM'>
							...
							passionate about or identify with.
						</p>
					</div>
				</div>
				<div className='flex items-center gap-3'>
					...
					<div>
						...
						<p className='text-secdcolor text-fontM'>
							Deepen your understanding by reading the description and details
							provided about each project. Find out how they are making an
							impact and what goals they are looking to achieve.
						</p>
					</div>
				</div>
				<div className='flex items-center gap-3'>
					...
					<div>
						...
						<p className='text-secdcolor text-fontM'>
							...
							consider most valuable and meaningful.
						</p>
					</div>
				</div>
				<div className='flex items-center gap-3'>
					...
					<div>
						...
						<p className='text-secdcolor text-fontM'>
							If you are in a position to do so, consider contributing
							financially to the selected project. Every small contribution
							counts and can make a difference in carrying out important
							initiatives.
						</p>
					</div>
				</div>
