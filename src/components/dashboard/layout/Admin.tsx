        ...
        <form className="flex flex-col w-[550px] gap-5 mx-auto mt-5">
          ...
          <section className="flex justify-center flex-wrap gap-x-6 gap-y-4">
            <div className="flex flex-col w-[250px]">
              <label htmlFor="id" className="text-thircolor text-fontL font-semibold">Profile  ID</label>
              <input 
              type="text" 
              name="id" 
              required
            ...
            <div className="flex flex-col w-[250px]">
              <label htmlFor="round" className="text-thircolor text-fontL font-semibold">Round Name</label>
              <input 
              type="text" 
              name="round" 
              required
            ...
            <div className="flex flex-col w-[250px]">
              <label htmlFor="img" className="block text-fontL font-semibold text-thircolor">Banner</label>
              <input 
              type="file"
              name="img"
              id="img"
            ...
            <div className="flex flex-col w-[250px]">
              <label htmlFor="ammount" className="block text-fontL font-semibold text-thircolor">Founding Amount</label>
              <input 
              type="number"
              name="ammount"
              id="ammount"
            ...
            <div className="flex flex-col w-[250px]">
              <label htmlFor="R-Begging" className="block text-fontL font-semibold text-thircolor">Registration Beginning</label>
              <input 
              type="datetime-local"
              name="R-Begging"
              id="R-Begging"
            ...
            <div className="flex flex-col w-[250px]">
              <label htmlFor="R-End" className="block text-fontL font-semibold text-thircolor">Registration Deadline</label>
              <input 
              type="datetime-local"
              name="R-Begging"
              id="R-Begging"
            ...
            <div className="flex flex-col w-[250px]">
              <label htmlFor="A-Begging" className="block text-fontL font-semibold text-thircolor">Allocation Beginning</label>
              <input 
              type="datetime-local"
              name="A-Begging"
              id="A-Begging"
            ...
            <div className="flex flex-col w-[250px]">
              <label htmlFor="A-End" className="block text-fontL font-semibold text-thircolor">Allocation Deadline</label>
              <input 
              type="datetime-local"
              name="A-End"
              id="A-End"
